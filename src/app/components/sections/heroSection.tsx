...
export function HeroSection() {
  ...
  return (
    <section className="py-[5vh] col-span-1 grid grid-cols-1  sm:grid-cols-2 gap-5 items-center h-screen">
      <div className="flex justify-center h-full">
        <div>
          <Heading onAnimationComplete={handleHeadingAnimationComplete} />
        </div>
      </div>
      <div className="z-0 relative grid grid-cols-3 border-4 sm:border-y-2 border-neutral-900 h-[70vh] w-full rounded-lg overflow-hidden">
